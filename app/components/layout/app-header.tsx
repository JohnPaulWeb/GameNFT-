  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 md:h-20 shrink-0 items-center gap-4 border-b border-white/10 bg-gradient-to-r from-[hsl(var(--bg-void))] via-[hsl(var(--bg-void))] to-cyan-500/5 backdrop-blur-2xl px-4 md:px-8 relative overflow-hidden shadow-lg shadow-cyan-500/5">
      ...
      <div className="flex-1 flex items-center justify-center relative z-10">
        <div className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-white/8 to-white/3 border border-white/15 backdrop-blur-md shadow-lg shadow-cyan-500/10 transition-all duration-300 hover:border-cyan-400/40 hover:bg-gradient-to-r hover:from-white/12 hover:to-white/5">
